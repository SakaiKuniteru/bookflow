...
export async function danhSachChiNhanh(donViId, taiKhoanId, xemTatCa, client) {
...
export async function layChiNhanh(donViId, chiNhanhId, client, khoa = false) {
...
export async function taoChiNhanhDb(donViId, actorId, duLieu, client) {
...
export async function capNhatChiNhanhDb(donViId, chiNhanhId, actorId, duLieu, client) {
    const cacTruong = Object.keys(duLieu);
...
export async function doiTrangThaiChiNhanh(donViId, chiNhanhId, actorId, trangThai, client) {
    const { rows } = await query(
...
export async function phanCongHieuLuc(donViId, taiKhoanId, chiNhanhId, client) {
    const { rows } = await query(
...
export async function phanCongTheoThanhVien(donViId, thanhVienId, chiNhanhId, client, khoa = false) {
...
export async function boChiNhanhChinhCu(donViId, thanhVienId, client) {
    await query(
...
export async function taoPhanCong(donViId, thanhVienId, chiNhanhId, laChinh, actorId, client) {
    const { rows } = await query(
...
export async function suaPhanCong(phanCongId, laChinh, actorId, client) {
    const { rows } = await query(
...
export async function ketThucPhanCong(phanCongId, actorId, client) {
    const { rows } = await query(
...
export async function ketThucVaiTroChiNhanh(donViId, thanhVienId, chiNhanhId, actorId, client) {
    await query(
...
export async function boQuanLyChiNhanh(donViId, chiNhanhId, thanhVienId, actorId, client) {
    await query(
...
export async function danhSachNhanVienChiNhanh(donViId, chiNhanhId, client) {
    const { rows } = await query(
...
export async function chonChiNhanhPhien(phienId, taiKhoanId, donViId, chiNhanhId, client) {
    const { rows } = await query(
...
export async function boChiNhanhKhoiPhien(donViId, chiNhanhId, taiKhoanId, client) {
    await query(
...
export async function ghiNhatKyChiNhanh({ donViId, actorId, doiTuongId, hanhDong, requestId }, client) {
    await query(
