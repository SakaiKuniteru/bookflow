...
export async function layTaiKhoanDuDieuKien(taiKhoanId, client) {
...
export async function khoaPhepTaoDonVi(taiKhoanId, client) {
    const { rows } = await query(
...
export async function taoDonViDb(duLieu, client) {
    const { rows } = await query(
...
export async function taoVaiTroMacDinh(donViId, actorId, client) {
    const { rows } = await query(
...
export async function ganQuyenQuanTri(donViId, vaiTroId, actorId, client) {
...
export async function taoThanhVienSangLap(donViId, taiKhoan, client) {
    const { rows } = await query(
...
export async function ganVaiTroSangLap(donViId, thanhVienId, vaiTroId, actorId, client) {
    const { rows } = await query(
...
export async function suDungPhepTaoDonVi(phepId, donViId, client) {
    const { rowCount } = await query(
...
export async function chonDonViChoPhien(phienId, taiKhoanId, donViId, client) {
    const { rowCount } = await query(
...
export async function danhSachDonViTheoTaiKhoan(taiKhoanId, client) {
    const { rows } = await query(
...
export async function thanhVienDangLam(taiKhoanId, donViId, client) {
    const { rows } = await query(
        `SELECT EXISTS (
...
export async function layDonViHienTai(taiKhoanId, donViId, client) {
    const { rows } = await query(
...
export async function khoaDonVi(donViId, client) {
    const { rows } = await query(
...
export async function capNhatDonViDb(donViId, duLieu, client) {
...
export async function ghiNhatKyDonVi({ donViId, actorId, hanhDong, requestId }, client) {
    await query(
